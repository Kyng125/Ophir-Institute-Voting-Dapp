...
Functions of voting dapp

1. It accepts proposal Name, and number for tracking

2. It allows for members to vote and exercise voting ability. i.e. keep track of voting, check if voters are authenticated to vote.

3. It has an "authenticator" to approve wallets to vote

*/

contract TestVotingDapp {
